...
$numresults = $sql->db_Select("survey_results","*", "results_survey_id='".intval($arg[0])."' ORDER BY results_datestamp ASC");
...
header("Content-Disposition: attachment; filename=$survey_name.xls");
